...
/// @notice Example token portal for tutorial. Hardcodes caller_on_l1 to address(0).
contract ExampleTokenPortal {
    ...
    // docs:start:withdraw
    /// @notice Withdraw tokens after consuming an L2->L1 message. Hardcodes caller to address(0).
    function withdraw(
        address _recipient,
        uint256 _amount,
        Epoch _epoch,
